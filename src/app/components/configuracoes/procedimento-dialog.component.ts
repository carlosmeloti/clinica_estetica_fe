    ...
    <div class="dialog-header">
      <div class="header-info">
        ...
        <div class="header-text">
          ...
          <p class="header-subtitle">Cadastre nome, preço sugerido e duração</p>
        </div>
      </div>
      ...
      <form [formGroup]="form" class="form-container">
        ...
        <div class="grid-row">
          <mat-form-field appearance="outline">
            <mat-label>Preço sugerido (R$)</mat-label>
            <input matInput type="number" formControlName="precoSugerido" min="0" step="0.01">
          </mat-form-field>
...
export class ProcedimentoDialogComponent {
  ...
  constructor(
    ...
    this.form = this.fb.group({
      ...
      precoSugerido: [this.data?.procedimento?.precoSugerido ?? null],
  ...
  onSave(): void {
    ...
    const payload: Procedimento = {
      nome: raw.nome?.trim(),
      precoSugerido: raw.precoSugerido != null && raw.precoSugerido !== ''
        ? Number(raw.precoSugerido)
        : undefined,
